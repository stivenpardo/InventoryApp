    ...
    public partial class RestoreMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "10c21c03-7247-411c-b4be-afd95ce33531", "Calle 8 con 23", "Bodega Central" },
                    { "cae2ce27-ad0f-4617-81a2-61080205bf2a", "Calle 12 con 23", "Bodega Norte" },
                    { "f2885fe5-1682-431c-bdce-75fe87db2ff6", "Calle 5 con 17", "Bodega Sur" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "H-01", "ASH", "Buena calidad", "Limpido", 0 },
                    { "A-01", "ASP", "Nueva línea", "Talcos para los pies", 0 },
                    { "P-01", "PLL", "Comprado al galpon del pollo de Cali", "Pechuga Amarilla de campo", 0 },
                    { "P-02", "PLL", "Comprado al galpon del pollo de Cali", "Alas con costillar Amarilla de campo", 0 },
                    { "P-03", "PLL", "Comprado al galpon del pollo de Cali", "Pernil Amarillo de campo", 0 }
                });
